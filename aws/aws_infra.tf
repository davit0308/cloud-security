...
# Lưu ý: Hệ thống sẽ tự động tìm kiếm VPC mặc định hoặc bạn điền ID tĩnh vào đây
data "aws_vpc" "aws_hybrid_vpc" {
  default = true 
  # Nếu bạn muốn chỉ định đích danh một VPC ID cụ thể, hãy comment dòng trên và dùng dòng dưới:
  # id = "vpc-0a45f652128928f23" 
}
